...
(function () {
  ...
  const INDEX = [
    ...
    { term: 'What is Philosophy? Why It Still Matters', kind: 'Lesson 1', topic: 'Philosophy', file: 'philosophy/lessons/0001-what-is-philosophy.html', desc: 'Triaging empirical, conceptual and normative questions — and why the split matters.' },
    { term: 'Epistemology — How Do We Know Anything?', kind: 'Lesson 2', topic: 'Philosophy', file: 'philosophy/lessons/0002-epistemology-knowledge.html', desc: 'Justified true belief, Gettier problems, rationalism vs empiricism.' },
    { term: 'Ethics — How Should We Act?', kind: 'Lesson 3', topic: 'Philosophy', file: 'philosophy/lessons/0003-ethics-how-should-we-act.html', desc: 'Consequentialism, deontology, virtue ethics — where the normative premises come from.' },
    { term: 'Metaphysics — What is Real?', kind: 'Lesson 4', topic: 'Philosophy', file: 'philosophy/lessons/0004-metaphysics-what-is-real.html', desc: 'Free will and personal identity, worked as inconsistent triads.' },
    { term: 'Logic & Argumentation — The Philosopher\'s Toolkit', kind: 'Lesson 5', topic: 'Philosophy', file: 'philosophy/lessons/0005-philosophical-argumentation.html', desc: 'Counterexamples, thought experiments, charity, reductio, reflective equilibrium.' },
    { term: 'Existentialism', kind: 'Lesson 6', topic: 'Philosophy', file: 'philosophy/lessons/0006-existentialism.html', desc: 'Existence precedes essence, anxiety, bad faith, the absurd, authenticity.' },
    { term: 'Philosophy of Mind', kind: 'Lesson 7', topic: 'Philosophy', file: 'philosophy/lessons/0007-philosophy-of-mind.html', desc: 'The hard problem, qualia, Mary\'s room, zombies, functionalism.' },
    { term: 'Stoicism — Ancient & Modern', kind: 'Lesson 8', topic: 'Philosophy', file: 'philosophy/lessons/0008-stoicism.html', desc: 'Virtue as the only good, preferred indifferents, assent, and what pop Stoicism drops.' },
    { term: 'Key Thinkers: Plato to Wittgenstein', kind: 'Lesson 9', topic: 'Philosophy', file: 'philosophy/lessons/0009-key-thinkers-map.html', desc: 'Nine thinkers, one reframing move each, mapped onto the rest of the course.' },
    ...
    { term: 'Three Kinds of Question', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0001-what-is-philosophy.html', anchor: 'three-kinds-of-question', desc: 'Empirical, conceptual, normative — sorted by what would settle them.', keywords: ['triage', 'empirical', 'normative'] },
    { term: 'Conceptual Analysis', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0001-what-is-philosophy.html', anchor: 'conceptual-analysis', desc: 'Propose necessary and sufficient conditions, then hunt a counterexample.' },
    { term: "Russell's Residue", kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0001-what-is-philosophy.html', anchor: 'russell-residue', desc: 'Definitely answerable questions become sciences; the residue is philosophy.' },
    { term: 'JTB (Justified True Belief)', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0002-epistemology-knowledge.html', anchor: 'jtb', desc: 'The classic analysis of knowledge — three conditions, each necessary, jointly insufficient.' },
    { term: 'Gettier Problem', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0002-epistemology-knowledge.html', anchor: 'gettier-problem', desc: 'Justified true belief that is true only by luck, so not knowledge.', keywords: ['epistemic luck', 'stopped clock'] },
    { term: 'Reliabilism', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0002-epistemology-knowledge.html', anchor: 'reliabilism', desc: 'Knowledge requires a reliable, truth-conducive belief-forming process.' },
    { term: 'Safety & Sensitivity', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0002-epistemology-knowledge.html', anchor: 'safety-sensitivity', desc: 'Modal repairs to JTB, stated over nearby possible worlds.' },
    { term: 'A Priori vs A Posteriori', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0002-epistemology-knowledge.html', anchor: 'a-priori', desc: 'Justification independent of experience vs dependent on it — the rationalism/empiricism split.' },
    { term: 'Normative Ethics vs Metaethics', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0003-ethics-how-should-we-act.html', anchor: 'normative-vs-metaethics', desc: 'Which acts are right, versus what kind of claim a moral claim is.' },
    { term: 'Consequentialism', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0003-ethics-how-should-we-act.html', anchor: 'consequentialism', desc: 'An act is right if its outcomes are at least as good as any alternative\'s.', keywords: ['utilitarianism', 'Mill', 'Bentham'] },
    { term: 'Deontology', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0003-ethics-how-should-we-act.html', anchor: 'deontology', desc: 'Some acts are forbidden regardless of consequences — Kant\'s categorical imperatives.' },
    { term: 'Virtue Ethics', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0003-ethics-how-should-we-act.html', anchor: 'virtue-ethics', desc: 'Right action is what a person of good character would do.', keywords: ['arete', 'phronesis', 'eudaimonia', 'Aristotle'] },
    { term: 'Free Will Triad', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0004-metaphysics-what-is-real.html', anchor: 'determinism', desc: 'Determinism, the alternatives requirement, and free will — inconsistent together.' },
    { term: 'Compatibilism', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0004-metaphysics-what-is-real.html', anchor: 'compatibilism', desc: 'Freedom is acting from your own unobstructed reasons, so determinism is no threat.' },
    { term: 'Frankfurt Cases', kind: 'Example', topic: 'Philosophy', file: 'philosophy/lessons/0004-metaphysics-what-is-real.html', anchor: 'frankfurt-cases', desc: 'Responsible for an act you could not have avoided — kills the alternatives requirement.' },
    { term: 'Personal Identity', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0004-metaphysics-what-is-real.html', anchor: 'personal-identity', desc: "Locke's psychological continuity criterion, and the branching case that breaks it.", keywords: ['teleporter', 'ship of theseus'] },
    { term: 'Counterexample Method', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0005-philosophical-argumentation.html', anchor: 'counterexample-method', desc: 'Restate a thesis as a universal, then produce one coherent case where it fails.' },
    { term: 'Thought Experiment', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0005-philosophical-argumentation.html', anchor: 'thought-experiments', desc: 'A device of the imagination that isolates one variable by stipulating away the rest.' },
    { term: 'Principle of Charity', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0005-philosophical-argumentation.html', anchor: 'principle-of-charity', desc: 'Reconstruct the opposing argument at full strength before attacking it.', keywords: ['steelman', 'straw man'] },
    { term: 'Reductio ad Absurdum', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0005-philosophical-argumentation.html', anchor: 'reductio', desc: 'Assume the thesis, derive an absurdity, reject it — unless the opponent bites the bullet.' },
    { term: 'Reflective Equilibrium', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0005-philosophical-argumentation.html', anchor: 'reflective-equilibrium', desc: 'Mutual adjustment of principles and case verdicts until they cohere.' },
    { term: 'Existence Precedes Essence', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0006-existentialism.html', anchor: 'existence-precedes-essence', desc: 'No pre-given human nature — what you are is the running total of what you do.' },
    { term: 'Bad Faith', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0006-existentialism.html', anchor: 'bad-faith', desc: "Sartre's term for recasting a choice as a fact about your role or nature." },
    { term: 'The Absurd', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0006-existentialism.html', anchor: 'the-absurd', desc: 'Camus: the collision between our demand for meaning and a silent universe.' },
    { term: 'Authenticity', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0006-existentialism.html', anchor: 'authenticity', desc: 'Owning a choice as yours — not "being true to your real self."' },
    { term: 'Hard Problem of Consciousness', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0007-philosophy-of-mind.html', anchor: 'hard-problem', desc: 'Why is any functional process accompanied by experience at all?', keywords: ['Chalmers', 'easy problems'] },
    { term: 'Qualia', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0007-philosophy-of-mind.html', anchor: 'qualia', desc: 'The felt, subjective qualities of experience — what function seems to leave out.' },
    { term: "Nagel's Bat", kind: 'Example', topic: 'Philosophy', file: 'philosophy/lessons/0007-philosophy-of-mind.html', anchor: 'nagel-bat', desc: 'Consciousness as there being something it is like to be an organism.' },
    { term: "Knowledge Argument (Mary's Room)", kind: 'Example', topic: 'Philosophy', file: 'philosophy/lessons/0007-philosophy-of-mind.html', anchor: 'knowledge-argument', desc: 'Mary knows every physical fact, then learns something on seeing red.' },
    { term: 'Philosophical Zombies', kind: 'Example', topic: 'Philosophy', file: 'philosophy/lessons/0007-philosophy-of-mind.html', anchor: 'zombies', desc: 'A physical duplicate with no experience — contested at conceivability implies possibility.' },
    { term: 'Functionalism', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0007-philosophy-of-mind.html', anchor: 'functionalism', desc: 'A mental state is its causal role, hence multiply realizable in any substrate.' },
    { term: 'Virtue is the Only Good', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0008-stoicism.html', anchor: 'virtue-only-good', desc: 'Stoic core claim — everything external is indifferent to whether life goes well.' },
    { term: 'Preferred Indifferents', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0008-stoicism.html', anchor: 'indifferents', desc: 'Health, wealth, reputation — energetically pursued, yet not constituents of the good life.' },
    { term: 'Up To Us (Assent to Impressions)', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0008-stoicism.html', anchor: 'up-to-us', desc: "Epictetus' division, narrower than \"what you control\": only assent is fully ours." },
    { term: 'Passions as Judgments', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0008-stoicism.html', anchor: 'passions-as-judgments', desc: 'An emotion contains a judgment, so it can be false — and corrected, not suppressed.' },
    { term: 'Genealogy (Nietzsche)', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0009-key-thinkers-map.html', anchor: 'nietzsche', desc: 'Ask where a value came from and whom it served, rather than whether it is true.' },
    { term: 'Transcendental Turn (Kant)', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0009-key-thinkers-map.html', anchor: 'kant', desc: 'Ask what experience presupposes, rather than how the mind conforms to objects.' },
    { term: 'Private Language Argument', kind: 'Definition', topic: 'Philosophy', file: 'philosophy/lessons/0009-key-thinkers-map.html', anchor: 'wittgenstein', desc: 'A language of purely private sensations could have no checkable rules.' },
    ...
    { term: 'Core Philosophy Cheat Sheet', kind: 'Reference doc', topic: 'Philosophy', file: 'philosophy/reference/core-branches-cheatsheet.html', desc: 'Compressed summary of lessons 1–9 — terms, positions, and the thinkers\' moves.' },
    ...
    { term: 'Adjunctions', kind: 'Lesson 5', topic: 'Category Theory', file: 'category-theory/lessons/0005-adjunctions.html', desc: 'The construction that unifies free/forgetful pairs, currying, and more under one idea.' },
    { term: 'Adjunction (Definition)', kind: 'Definition', topic: 'Category Theory', file: 'category-theory/lessons/0005-adjunctions.html', anchor: 'adjunction-definition', desc: 'F ⊣ G: a natural bijection Hom(F(A),B) ≅ Hom(A,G(B)) for every A and B.' },
    { term: 'Unit & Counit', kind: 'Definition', topic: 'Category Theory', file: 'category-theory/lessons/0005-adjunctions.html', anchor: 'unit-counit', desc: 'η: Id ⇒ G∘F and ε: F∘G ⇒ Id, satisfying the triangle identities.' },
    { term: 'Currying as an Adjunction', kind: 'Technique', topic: 'Category Theory', file: 'category-theory/lessons/0005-adjunctions.html', anchor: 'currying-adjunction', desc: '(–×B) ⊣ (–)^B — curry/uncurry, with the counit as literal function application.' },
    { term: 'Free Monoid & Forgetful Functor', kind: 'Technique', topic: 'Category Theory', file: 'category-theory/lessons/0005-adjunctions.html', anchor: 'free-forgetful-monoid', desc: 'List<A> as the free monoid on A — fold as the witness of the adjunction.' },
    { term: 'Adjunctions Give Monads', kind: 'Theorem', topic: 'Category Theory', file: 'category-theory/lessons/0005-adjunctions.html', anchor: 'adjunctions-give-monads', desc: 'T = G∘F for any adjunction F ⊣ G — where lesson 4\'s Option monad actually comes from.' },
    ...
    // ── Quantum Computing: lesson-level entries ──
    { term: 'Qubits, the Bloch Sphere & Single-Qubit Gates', kind: 'Lesson 1', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0001-qubits-bloch-sphere-single-qubit-gates.html', desc: 'From state vector to Bloch sphere geometry, and the gates that rotate a qubit around it.' },
    { term: 'Bloch Sphere', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0001-qubits-bloch-sphere-single-qubit-gates.html', anchor: 'bloch-sphere', desc: 'A single qubit state, up to global phase, as a point on a sphere.' },
    { term: 'Unitary Gates', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0001-qubits-bloch-sphere-single-qubit-gates.html', anchor: 'unitary-gates', desc: 'Every quantum gate is a unitary matrix — a rotation of the Bloch sphere.' },
    { term: 'Pauli Gates (X, Y, Z)', kind: 'Reference', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0001-qubits-bloch-sphere-single-qubit-gates.html', anchor: 'pauli-gates', desc: '180° rotations about the Bloch sphere\'s three axes — bit flip, phase flip, both.', keywords: ['pauli', 'x gate', 'z gate', 'y gate', 'bit flip', 'phase flip'] },
    { term: 'Hadamard Gate', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0001-qubits-bloch-sphere-single-qubit-gates.html', anchor: 'hadamard-gate', desc: 'H — turns basis states into equal superpositions and back.', keywords: ['h gate'] },
    { term: 'S & T Phase Gates', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0001-qubits-bloch-sphere-single-qubit-gates.html', anchor: 'phase-gates', desc: 'Quarter-turn and eighth-turn rotations about the z-axis.' },

    { term: 'Multi-Qubit Systems, Entanglement & Circuits', kind: 'Lesson 2', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0002-multi-qubit-entanglement-circuits.html', desc: 'Tensor products of gates, CNOT, and building a Bell state as a circuit.' },
    { term: 'Tensor Product of Gates (U ⊗ I)', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0002-multi-qubit-entanglement-circuits.html', anchor: 'tensor-product-gates', desc: 'Applying a gate to one qubit while leaving others untouched.' },
    { term: 'CNOT Gate', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0002-multi-qubit-entanglement-circuits.html', anchor: 'cnot-gate', desc: 'Controlled-NOT — flips the target qubit only if the control is |1⟩.', keywords: ['controlled not'] },
    { term: 'Bell State Circuit', kind: 'Technique', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0002-multi-qubit-entanglement-circuits.html', anchor: 'bell-state-circuit', desc: 'H then CNOT — the standard two-gate recipe for manufacturing entanglement.' },
    { term: 'Exponential State Space (n qubits, 2ⁿ amplitudes)', kind: 'Note', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0002-multi-qubit-entanglement-circuits.html', anchor: 'exponential-state-space', desc: 'Why 2ⁿ amplitudes doesn\'t mean automatic exponential speedup.' },

    { term: 'Universal Gates, Reversibility & No-Cloning', kind: 'Lesson 3', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0003-universal-gates-reversibility-no-cloning.html', desc: 'Why every quantum gate must be reversible, and why you can\'t copy an unknown qubit.' },
    { term: 'Reversibility (classical vs. quantum gates)', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0003-universal-gates-reversibility-no-cloning.html', anchor: 'reversibility', desc: 'Unitary gates always invert; classical AND/OR generally don\'t.' },
    { term: 'Toffoli Gate (CCNOT)', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0003-universal-gates-reversibility-no-cloning.html', anchor: 'toffoli-gate', desc: 'Universal for classical reversible computation.' },
    { term: 'Universal Gate Set {H, T, CNOT}', kind: 'Theorem', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0003-universal-gates-reversibility-no-cloning.html', anchor: 'universal-gate-set', desc: 'Enough to approximate any unitary, per the Solovay-Kitaev theorem.' },
    { term: 'No-Cloning Theorem', kind: 'Theorem', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0003-universal-gates-reversibility-no-cloning.html', anchor: 'no-cloning-theorem', desc: 'No unitary can copy an unknown qubit — proved from linearity alone.', keywords: ['cloning'] },

    { term: 'Quantum Interference & the Deutsch-Jozsa Algorithm', kind: 'Lesson 4', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0004-interference-deutsch-jozsa.html', desc: 'The actual mechanism behind quantum speedup, and the first algorithm that uses it.' },
    { term: 'Quantum Interference', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0004-interference-deutsch-jozsa.html', anchor: 'interference', desc: 'Amplitudes adding constructively or destructively — the real source of quantum speedup, not "checking every answer at once."' },
    { term: 'Oracle (O_f)', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0004-interference-deutsch-jozsa.html', anchor: 'oracle', desc: 'A black-box unitary computing |x⟩|y⟩ → |x⟩|y⊕f(x)⟩.' },
    { term: 'Phase Kickback', kind: 'Technique', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0004-interference-deutsch-jozsa.html', anchor: 'phase-kickback', desc: 'O_f|x⟩|−⟩ = (−1)^f(x)|x⟩|−⟩ — encoding a function\'s output as a phase.' },
    { term: 'Deutsch-Jozsa Algorithm', kind: 'Algorithm', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0004-interference-deutsch-jozsa.html', anchor: 'deutsch-jozsa', desc: 'Determines constant vs. balanced with one oracle query, proving quantum speedup is possible.' },

    { term: "Grover's Algorithm & Amplitude Amplification", kind: 'Lesson 5', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0005-grovers-algorithm.html', desc: 'The geometric picture behind the quadratic search speedup, and why it\'s provably optimal.' },
    { term: 'Unstructured Search Problem', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0005-grovers-algorithm.html', anchor: 'grover-problem', desc: 'Finding a marked item among N with only oracle access — O(N) classically.' },
    { term: 'Amplitude Amplification', kind: 'Technique', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0005-grovers-algorithm.html', anchor: 'amplitude-amplification', desc: 'Two reflections compose into a rotation, steadily turning the state toward the marked item.' },
    { term: 'Diffusion Operator (Inversion About the Mean)', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0005-grovers-algorithm.html', anchor: 'diffusion-operator', desc: 'D = 2|s⟩⟨s| − I — reflects every amplitude about their average.' },
    { term: 'Grover Optimality (BBBV theorem)', kind: 'Theorem', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0005-grovers-algorithm.html', anchor: 'grover-optimality', desc: 'No quantum algorithm can solve unstructured search in fewer than Ω(√N) queries.' },

    { term: 'The Quantum Fourier Transform & Phase Estimation', kind: 'Lesson 6', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0006-quantum-fourier-transform-phase-estimation.html', desc: 'The circuit that finds periods, and the workhorse subroutine behind Shor\'s algorithm.' },
    { term: 'Quantum Fourier Transform (QFT)', kind: 'Definition', topic: 'Quantum Computing', file: 'quantum-computing/lessons/0006-quantum-fourier-transform-phase-estimation.html', anchor: 'qft-definition', desc: 'QFT|x⟩ = (1/√N)Σ e^(2πixy/N)|y⟩ — concentrates amplitude on a hidden period.', keywords: ['fourier'] },
    ...
    { term: 'Knowledge Graphs (Agent Memory)', kind: 'Technique', topic: 'AI Engineering', file: 'ai-engineering/lessons/0003-context-memory-summarization-retrieval.html', anchor: 'knowledge-graphs', desc: 'Entities and named relationships instead of similarity search — for multi-hop "what connects to what" queries.', keywords: ['graphrag', 'entity graph'] },
